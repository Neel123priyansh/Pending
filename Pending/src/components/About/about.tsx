...
function about() {
  return (
    <div id="aboutus" className='mt-20 flex flex-col'>
        ...
        <div className=' text-white flex flex-row ml-10 h-max max-w-[70%] bg-[#301934] font-urbanist rounded-tl-3xl p-10'>
        ...
        <div className=' text-white flex flex-row ml-10 h-max max-w-[70%] bg-[#301934] font-urbanist rounded-bl-3xl mt-1 p-10'/>
        </div>
        <div className=' text-white h-max max-w-[100%] bg-[#301934] font-urbanist rounded-tr-3xl rounded-br-3xl'>
        <img src={Aboutna}/>
        </div>
        </div>
    </div>
