...
function about() {
  return (
    <div id="aboutus" className='my-10 overflow-hidden flex gap-0 flex-row'>
        ...
        <div className='ml-10 h-52 overflow-hidden inset-0 w-[95%] bg-[#301934] rounded-bl-3xl mt-3 p-10'>
        </div>
        </div>
