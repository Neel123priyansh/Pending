...
function about() {
  return (
    <div id="aboutus" className='my-10 flex flex-row'>
        <div className=" flex flex-col">
        <div className=' text-white ml-10 w-[96%] bg-[#301934] font-urbanist rounded-tl-3xl p-10'>
        ...
        <div className='ml-10 h-52 w-[96%] overflow-hidden bg-[#301934] rounded-bl-3xl mt-[7px]'>
      ...
      />
        ...
        <div className= 'w-[150%] items-center overflow-hidden rounded-tr-3xl mr-10 rounded-br-3xl'>
