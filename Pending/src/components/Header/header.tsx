...
export default function header() {
  ...
  return (
    <div className='fixed z-50 w-full backdrop-blur-lg bg-white/5 border-b-2 border-white/1 flex justify-between items-center max-w-[100%] text-white h-24 bg-[#f7efd8] mx-auto'>
