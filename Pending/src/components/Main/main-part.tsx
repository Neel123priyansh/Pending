...
export default function main() {
  return (
    <div className='flex flex-col justify-center'>
        <div className='max-w-[100%] text-center mt-[120px] w-full font-[rgb(48 54 64)] font-playfair h-10 flex justify-center items-center font- font-[900] md:text-6xl sm:text-6xl'> 
